...
CREATE TABLE `Paper` (
  ...
  `timestampx` int(11) NOT NULL default '0',
...
insert into PaperStorage set paperStorageId=1, paperId=0, timestampx=0, mimetype='text/plain', paper='' on duplicate key update paper='';
